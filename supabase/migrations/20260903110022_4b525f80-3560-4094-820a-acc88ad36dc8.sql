...
AS $function$
DECLARE
  modules text[] := ARRAY['dashboard','financeiro','diario_obra','cronograma','relatorios','documentos','usuarios','configuracoes','clientes','ferramentas','relatorio_final','funcionarios'];
  m text;
BEGIN
